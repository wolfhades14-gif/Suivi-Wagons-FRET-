const CACHE_NAME = 'suivi-wagons-fret-v22-0';
const ASSETS = ['./','./index.html?v=22','./manifest.json','./header-train-bg.jpg','./icon-192.png','./icon-512.png','./icon-512-maskable.png'];
