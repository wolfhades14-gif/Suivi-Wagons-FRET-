const CACHE_NAME = "suivi-wagons-fret-v13-3";
const ASSETS = ["./","./index.html?v=13.3","./manifest.json","./icon-192.png","./icon-512.png","./icon-512-maskable.png","./header-train-bg.jpg"];
