const CACHE_NAME = "suivi-wagons-fret-v17-0";
const ASSETS = ["./","./index.html?v=15.0","./manifest.json","./icon-192.png","./icon-512.png","./icon-512-maskable.png","./header-train-bg.jpg"];
